...
import os.path
# data = FT.FusionTransformation()

# print(data.columnsls
...
ranking_df = pd.read_csv( '../data_preparation/raw_data/ranking_results.csv', sep = "|")
Ranking = RankingTransformation()
Ranking.set_ranking_df(ranking_df)
Ranking.transform()


results_df = pd.read_csv( '../data_preparation/raw_data/matches_results.csv', sep = "|")
...
Merged = FT.merging_data(Ranking.ranking_df, Results.result_df)
